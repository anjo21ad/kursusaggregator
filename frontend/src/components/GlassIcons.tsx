...
const gradientMapping: Record<string, string> = {
  // Kursusaggregator tema farver
  primary: 'linear-gradient(#FF6A3D, #E2572D)',
  secondary: 'linear-gradient(#7E6BF1, #6558D3)',
  accent: 'linear-gradient(#3ABEFF, #2AA8E8)',
  success: 'linear-gradient(#38D39F, #2BB889)',

  // Original farver (bevaret for kompatibilitet)
